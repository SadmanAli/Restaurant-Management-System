    ...
    private void btn_doneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_doneActionPerformed
        ...
        try{
            ...
            if(resultSet.next()){
                ...
                /*ResultSet rsss = statement.executeQuery("SELECT * FROM manager\n" +
                            "JOIN has ON manager.ID = has.Mg_ID\n" +
                            "WHERE manager.name = '"+username+"' AND manager.contact_no = '"+pass+"';");
                        
               String res = rsss.getString("Res_name");*/
